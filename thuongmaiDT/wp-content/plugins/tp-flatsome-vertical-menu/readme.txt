...
Contributors: pdutie94
Donate link: paypal.me/pdutie94
Tags: wp, flatsome, php, vertical, menu
...
1. Visit menu page: Menu -> Create new Menu -> Display location => TP Vertical Menu
1. Go Appearance -> Customize -> Header -> Header Builder , Add TP Vertical Menu element
...
== Changelog ==
= 1.1.4 =
* NEW: Options set menu with, sub menu with
